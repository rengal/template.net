...
namespace Resto.Front.PrintTemplates.Cheques.Xslt.TemplateModels
{
    ...
    public static class DeleteProductsServiceChequeToXmlConverterExtensions
    {
        [NotNull]
        public static XDocument ToXml([NotNull] this IDeleteProducts obj)
        {
            if (obj == null)
            ...
            obj.AppendToXml(document, "DeleteProducts");
            
            return document;
        }
        
        internal static void AppendToXml(this IDeleteProducts obj, XContainer parent, string elementName)
        {
