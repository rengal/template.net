...
{
    /// <summary>
    /// The characteristics of a PE image.
    /// </summary>
    [Flags]
    public enum PeCharacteristics : ushort
    {
        ...
        /// The file must be loaded at its preferred base address. If the base address is not available, the loader reports an error.
        /// </summary>
