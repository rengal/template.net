...
namespace Wintellect.PowerCollections
{
    ...
    public static class Algorithms
    {
        ...
        /// <param name="cultureInfo">CultureInfo to use for the conversion.</param>
        ...
        public static string ToString<T>(IEnumerable<T> collection, CultureInfo cultureInfo = null)
        {
            return ToString(collection, true, "{", ",", "}", cultureInfo ?? CultureInfo.InvariantCulture);
        }
        ...
        ///  is null.</exception>
        public static string ToString<T>(IEnumerable<T> collection, bool recursive, string start, string separator, string end, CultureInfo cultureInfo = null)
        {
            if (start == null)
            ...
            foreach (T item in collection)
            {
                ...
                if (item == null)
                    ...
                    builder.Append(Algorithms.ToString(Algorithms.TypedAs<object>((IEnumerable)item), recursive, start, separator, end, cultureInfo));
                else
                    builder.Append(System.Convert.ToString(item, cultureInfo));
        ...
        public static string ToString<TKey, TValue>(IDictionary<TKey, TValue> dictionary, CultureInfo cultureInfo = null)
        {
            if (cultureInfo == null) cultureInfo = CultureInfo.InvariantCulture;
            bool firstItem = true;
            ...
            foreach (KeyValuePair<TKey, TValue> pair in dictionary)
            {
                ...
                if (pair.Key == null)
                    ...
                    builder.Append(Algorithms.ToString(Algorithms.TypedAs<object>((IEnumerable)pair.Key), true, "{", ",", "}", cultureInfo));
                else
                ...
                if (pair.Value == null)
                    ...
                    builder.Append(Algorithms.ToString(Algorithms.TypedAs<object>((IEnumerable)pair.Value), true, "{", ",", "}", cultureInfo));
                else
