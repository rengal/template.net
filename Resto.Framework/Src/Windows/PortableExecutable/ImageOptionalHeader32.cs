...
{
    /// <summary>
    /// Represents the optional header format in a 32-bit application.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 1), PublicAPI]
    public struct ImageOptionalHeader32
    {
        public static readonly uint ChecksumOffset = MarshallingHelper.OffsetOf<ImageOptionalHeader32>(x => x.Checksum);
        public static readonly uint CertificateTableOffset = MarshallingHelper.OffsetOf<ImageOptionalHeader32>(x => x.CertificateTable);
