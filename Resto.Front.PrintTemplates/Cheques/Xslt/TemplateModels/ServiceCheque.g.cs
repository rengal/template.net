...
namespace Resto.Front.PrintTemplates.Cheques.Xslt.TemplateModels
{
    ...
    public interface IService
    {
        ...
        /// <summary>
        /// Флаг повторной печати блюд
        /// </summary>
        bool IsRepeatedPrint { get; }
    }

    public static class ServiceChequeToXmlConverterExtensions
    {
        [NotNull]
        public static XDocument ToXml([NotNull] this IService obj)
        {
            if (obj == null)
            ...
            obj.AppendToXml(document, "Service");
            
            return document;
        }
        
        internal static void AppendToXml(this IService obj, XContainer parent, string elementName)
        {
